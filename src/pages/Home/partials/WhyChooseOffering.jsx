        ...
        <div className="py-20 bg-[rgba(0,0,0,0.7)]">
          <div className="container grid grid-cols-12 gap-y-10 lg:gap-10 lg:items-center">
            ...
            <motion.div
              ...
              whileInView="visible"
            >
              <h2 className="text-4xl md:text-5xl font-bold text-white md:leading-tight mb-2">
                Why Choose This Offering?
              </h2>
              <h3 className="text-3xl md:text-4xl font-bold text-gray-300 md:leading-tight mb-5">
